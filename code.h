...
void TestBubbleSort(){
    for(int i=0;i<1000;++i){
        ...
        if(!TestBubbleSortHelper(temp)){
            cout << "BubbleSort算法的实现有误" << endl;
        }
    }
    cout << "BubbleSort算法实现的正确性检测通过" << endl;
}
...
void TestMergeSort(){
    for(int i=0;i<1000;++i){
        ...
        if(!testMergeSortHelper(temp)){
            cout << "MergeSort算法的实现有误" << endl;
        }
    }
    cout << "MergeSort算法实现的正确性检测通过" << endl;
}
...
void CompareTwoAlgorithm(){
    ...
    cout << "对于相同的10000个随机数组，冒泡排序的时间花销为：" << BubbleSortCost << endl;
    cout << "对于相同的10000个随机数组，归并排序的时间花销为：" << MergeSortCost << endl;
}
